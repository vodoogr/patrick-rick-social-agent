...
CREATE TABLE songs (
  ...
  era TEXT NOT NULL, -- Blue, Yellow, Red, Green, etc.
  album TEXT,
...
-- Post Angles (Predefined rotation)
CREATE TABLE post_angles (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
-- Seed Post Angles
INSERT INTO post_angles (day_number, name, description) VALUES
(1, 'Atmospheric Teaser', 'Focus on the mood and visual atmosphere of the era.'),
(2, 'Lyric Fragment', 'Highlight a powerful line from the song.'),
(3, 'Emotional Hook', 'Connect the song’s meaning to a relatable emotion.'),
(4, 'Cinematic Visual Concept', 'Showcase deep artistic visual metaphors.'),
(5, 'Era Storytelling', 'Deep dive into the lore and narrative of the current Era.'),
(6, 'Intimate Interpretation', 'A more personal, raw connection to the music.'),
(7, 'Listening Invitation', 'Direct call to stream the song on platforms.');
